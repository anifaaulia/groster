                                ...
                                <div class="card-body">
                                  ...
                                  <div class="d-sm-flex align-items-center mt-1 justify-content-between">
                                    <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                      <h4 class="me-2 fw-bold">$36,2531.00</h4>
                                    ...
                                    <table class="table select-table">
                                      ...
                                      <tbody>
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex ">
                                              <img src="{{ asset('dist/assets/images/faces/face1.jpg') }}" alt="">
                                              <div>
                                                <h5>Brandon Washington</h5>
                                                <p>Head admin</p>
                                              </div>
                                            </div>
                                          </td>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('dist/assets/images/faces/face2.jpg') }}" alt="">
                                              <div>
                                                <h5>Laura Brooks</h5>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('dist/assets/images/faces/face3.jpg') }}" alt="">
                                              <div>
                                                <h5>Wayne Murphy</h5>
                                                <p>Head admin</p>
                                              </div>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('dist/assets/images/faces/face4.jpg') }}" alt="">
                                              <div>
                                                <h5>Matthew Bailey</h5>
                                                <p>Head admin</p>
                                              </div>
                                            </div>
                                          </td>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="d-flex">
                                              <img src="{{ asset('dist/assets/images/faces/face5.jpg') }}" alt="">
                                              <div>
                                                <h5>Katherine Butler</h5>
                                                <p>Head admin</p>
                                              </div>
                                            </div>
                                          </td>
