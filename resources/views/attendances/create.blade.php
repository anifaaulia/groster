        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description"> Masukkan data kehadiran baru pada form di bawah ini. </p>
                    <form action="{{ route('attendances.store') }}" method="POST" class="forms-sample">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" id="status" required>
                                ...
                                <option value="left_early">Pulang Cepat (Left Early)</option>
                            </select>
                        </div>
